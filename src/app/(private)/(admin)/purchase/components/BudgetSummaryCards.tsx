...
export default function BudgetSummaryCards({ summary }: Props) {
  ...
  return (
    <div className="relative flex w-full gap-[30px] pb-10 max-lg:gap-5 max-sm:grid max-sm:grid-cols-2 max-sm:items-start max-sm:gap-4 max-sm:pb-0">
      ...
      {/* 2. 이번 달 지출액 + 호버 */}
      <div className="group relative flex flex-1 flex-col gap-5 overflow-visible rounded bg-gray-50 py-[30px] pl-[30px] pr-10 max-lg:gap-4 max-lg:p-5 max-sm:h-[156px] max-sm:overflow-hidden">
