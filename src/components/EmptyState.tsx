...
export default function EmptyState({
  ...
  return (
    <section className="flex w-[310px] flex-col items-center gap-[30px] self-center max-sm:w-full max-sm:gap-5">
      ...
      <div className="flex w-full flex-col items-center gap-[50px] max-sm:gap-10">
        <div className="flex w-[299px] flex-col items-center gap-2.5 text-center">
          <h2 className="w-full text-[24px] font-extrabold tracking-[-0.6px] text-gray-950 max-sm:text-[18px] max-sm:tracking-[-0.45px]">
            {title}
          </h2>
